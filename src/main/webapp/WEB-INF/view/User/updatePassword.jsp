...
<body>
<form action="${pageContext.request.contextPath}/user/editPassword.do" method="post" class="definewidth m20">
    ...
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><input type="text" name="user_name" readonly="readonly" value="${u.user_name}" /></td>
        </tr>
        <tr>
