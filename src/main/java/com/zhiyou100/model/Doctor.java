...
public class Doctor {
    ...
    public Education getEducation1() {
		return education1;
	}

	public void setEducation1(Education education1) {
	...
	public String toString() {
		return "Doctor [id=" + id + ", name=" + name + ", certificate_type=" + certificate_type + ", ID_num=" + ID_num
				...
				+ education + ", noted=" + noted + ", time=" + time + ", section=" + section + ", certificateType="
				+ certificateType + ", education1=" + education1 + "]";
	}
